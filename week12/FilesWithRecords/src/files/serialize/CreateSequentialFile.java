package files.serialize;// Fig. 14.18: CreateSequentialFile.java
...
import data.AccountRecordSerializable;
    ...
    public void addRecords() {
        ...
        while (input.hasNext()) // loop until end-of-file indicator
        {
            try // output values to file
            {
                ...
                if (accountNumber > 0) {
                    // create new record
                    var record = new AccountRecordSerializable(accountNumber, firstName, lastName, balance);
